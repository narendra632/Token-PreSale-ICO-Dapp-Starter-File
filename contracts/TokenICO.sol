...
contract TokenICO {
    ...
    function buyToken(uint256 _tokenAmount) public payable {
        ...
        require(_tokenAmount <= token.balanceOf(address(this)), "Not enought token left for sale");
    ...
    function transferToOwner(uint256 _amount) external payable {
        require(msg.value >= _amount, "Insufficient funds provided for the transfer");
